...
const Tomato = () => {
  ...
  return (
    <div className="disease-detection-container">
      ...
      <p>
        Upload a photo of your tomato plant to detect possible diseases using AI.
      </p>
        ...
        <div className="description-section">
          ...
          <div className="description-content">
            <p className="main-description">
              Our advanced AI system helps farmers identify and manage tomato plant
              diseases effectively. Using state-of-the-art machine learning
              algorithms, we can detect various diseases that commonly affect
              tomato crops, providing instant diagnosis and treatment
              recommendations.
            </p>
          ...
          {prediction && (
            <div className="prediction-result">
              ...
              <p>
                ...
                {diseaseDetails[prediction.disease]?.solution ||
                  "No information available."}
              </p>
              <p>
                <strong>Suggestion:</strong>{" "}
                {diseaseDetails[prediction.disease]?.suggestion ||
                  "No information available."}
              </p>
              <p>
                <strong>Precaution:</strong>{" "}
                {diseaseDetails[prediction.disease]?.precaution ||
                  "No information available."}
              </p>
              <button
